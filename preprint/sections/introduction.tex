...
\begin{equation*}
  n = 18\cdot 2^t + 1.
\end{equation*}
A pseudoline arrangement is an arrangement of curves, each pair
crossing exactly once, that need not be straight lines.
...
however, we found specific arrangements allowing a single iterative step,
yielding optimal affine arrangements for $n=41$ and $n=45$
and a projective arrangement of $49+1$ lines attaining the projective upper
bound (Appendix~\ref{sec:appendix-one-step}).
