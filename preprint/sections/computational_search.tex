...
see Appendix~\ref{sec:certified-package}.
...
given by the upper bound~\eqref{eq:upper-bound}.
...
normalization script described in Appendix~\ref{sec:certified-package}
