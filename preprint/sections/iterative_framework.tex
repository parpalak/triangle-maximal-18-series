...
Throughout the paper we use the best affine upper bound from
\cite[Theorem~1.3]{bartholdi2007}: for every simple affine
arrangement of $n$ lines or pseudolines with $n\equiv 1\pmod{6}$,
\begin{equation}\label{eq:bbl-upper-bound}
  a_3(\cA)\le \left\lfloor \frac{n(n-2)}{3}\right\rfloor
  =
  \frac{n(n-2)-2}{3}.
\end{equation}
An arrangement is \emph{$a_3$-maximal} if it attains this bound.
